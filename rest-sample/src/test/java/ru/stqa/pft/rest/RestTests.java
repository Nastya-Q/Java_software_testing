...
public class RestTests {
    ...
    public void createIssue() throws IOException {
        ...
        Issue newIssue = new Issue().withSubject("Ana test subject").withDescription("Ana test description");
    ...
    private Set<Issue> getIssues() throws IOException {
        String json = getExecutor().execute(Request.Get("http://bugify.stqa.ru/api/issues.json?page=1&limit=100"))
